...
class Ui_HomeWindow(object):
    def __init__(self, HomeWin):
        super().__init__()
        HomeWin.setWindowIcon(QtGui.QIcon(':/BloodSim.ico'))
    ...
    def setupUi(self):
        ...
        self.pushButton_2.setIcon(QtGui.QIcon(':/images/Homebutton2.png'))
        ...
        self.pushButton_3.setIcon(QtGui.QIcon(':/images/Homebutton3.png'))
        ...
        self.pushButton_1.setIcon(QtGui.QIcon(':/images/Homebutton1.png'))
        self.pushButton_1.setIconSize(QtCore.QSize(190, 41))

        self.label.setGeometry(QtCore.QRect(80, 0, 491, 300))
        self.label.setObjectName("label")
        self.label.setPixmap(QtGui.QPixmap(':/images/icon.jpg'))

        self.label_2.setGeometry(QtCore.QRect(72, 290, 491, 81))
        self.label_2.setObjectName("label_2")
        self.label_2.setPixmap(QtGui.QPixmap(':/images/title.jpeg'))
